...
public class PDFProcessorService {
    ...
    public static void prepareGenericMapForPDFTemplate(Map<String, Object> paramsMap,
    ...
    private static void preparePDFTableMap(Map<String, String> rowMap, Map<String, String> pdfFieldsMap, String fieldPrefix) {
    ...
    public static byte[] mergePDFs(byte[] primaryPDFBytes, List<byte[]> pdfList, int location) throws IOException, DocumentException {
